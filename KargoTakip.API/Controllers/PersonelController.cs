...
namespace KargoTakip.API.Controllers
{
    ...
    public class PersonelController : ControllerBase
    {
        ...
        {
            if (string.IsNullOrEmpty(personel.Adi) || string.IsNullOrEmpty(personel.Soyadi) || string.IsNullOrEmpty(personel.Email) 
                || string.IsNullOrEmpty(personel.Sifre) || string.IsNullOrEmpty(personel.Pozisyon))
                return BadRequest();
